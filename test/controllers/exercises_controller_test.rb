...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post exercises_url, params: { exercise: { answer: @exercise.answer, content: @exercise.content, number: @exercise.number } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { answer: @exercise.answer, content: @exercise.content, number: @exercise.number } }
